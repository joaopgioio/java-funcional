...
public class Iteracoes {
    public static void main(String[] args) {
        String[] nomes = {"Joao", "Joao", "Oliveira", "Santos", "Instrutor", "Java"};
    ...
    public static void imprimirNomesFiltrados(String... nomes) {
        ...
        String nomeparaImprimirDasStream = Stream.of(nomes)
                .filter(nome -> nome.equals("Joao"))
                .collect(Collectors.joining()); //String

        System.out.println("Nomes do Stream: "+nomeparaImprimirDasStream);

        //String nomeResultados = Stream.of(nomes).filter(nome -> nome.equals("Joao"))
        //        .collect(Collectors.joining());
        //System.out.println(nomeResultados);
    }
